...
ELSE DO: 
    ...
    RUN script("var " + p-c-type + "Data = [" + c-chart + "]" + CHR(10) + "window.onload = function() " + CHR(123) + CHR(10) + "var ctx" + p-c-id + " = document.getElementById('cnv" + p-c-id + "').getContext('2d'); window.my" + c-capitalize + " = new Chart(ctx" + p-c-id + ")." + c-capitalize + "(" + p-c-type + "Data, " + CHR(123) + "responsive : true" + CHR(125) + " )" + CHR(125) + ";" + CHR(10)).
END.
END PROCEDURE.
